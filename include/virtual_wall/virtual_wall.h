...
class VirtualWall : public costmap_2d::CostmapLayer
{
private:
    /* data */
    // msg system
   ...
   // ros::Publisher wall_maker_pub;
    ...
    std::vector<geometry_msgs::Point> wallPoint;

    void AddWallCallback(const geometry_msgs::PolygonConstPtr& msg);
    void DeleteWallCallback(const std_msgs::String& msg);

    // bool WallInterpolation();

    bool updateWall(costmap_2d::Costmap2D& master_grid);
    bool bUpdate;
    bool virtualWall_received_;
